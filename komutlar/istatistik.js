...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@419840467929137168> \n `Eren Baltacı`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **13.02.2019**'de yapılmaya başlanmıştır")
    .setFooter('Techno Bot', client.user.avatarURL)
    .setTimestamp()
...
exports.conf = {
  enabled: true,
    guildOnly: true,
  aliases: ['istatistik', 'stats', 'bot-bilgi', 'i'],
  permLevel: 0
};
